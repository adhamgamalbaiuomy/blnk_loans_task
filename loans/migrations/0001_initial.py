# Generated by Django 5.1.6 on 2025-03-05 23:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('provider', 'Loan Provider'), ('customer', 'Loan Customer'), ('bank', 'Bank Personnel')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_personnel', models.OneToOneField(limit_choices_to={'role': 'bank'}, on_delete=django.db.models.deletion.CASCADE, related_name='loan_policy', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='LoanProvider',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total_budget', models.DecimalField(decimal_places=2, help_text='Total funds provided', max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fund_applications', to='loans.loanprovider')),
            ],
        ),
    ]
